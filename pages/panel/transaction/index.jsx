...
const Courses = () => {
  ...
  const [txt, setTxt] = useState([
    {num:"1",order:"21425",price:"$18$",Date:"sep 10 , 2022",state:"Success"},
    {num:"2",order:"21425",price:"$18$",Date:"sep 10 , 2022",state:"Fail"},
    {num:"3",order:"21425",price:"$18$",Date:"sep 10 , 2022",state:"Success"},
    {num:"4",order:"21425",price:"$18$",Date:"sep 10 , 2022",state:"Success"},
    {num:"5",order:"21425",price:"$18$",Date:"sep 10 , 2022",state:"Fail"},
    {num:"6",order:"21425",price:"$18$",Date:"sep 10 , 2022",state:"Success"},
  ])
  ...
  const displayItems = txt
    ...
    .map((i) => {
      return (
        ...
        <td>{i.price}</td>
        <td>{i.Date}</td>
        {i.state === "Success" ? <td className={co.greenc}>{i.state}</td>:<td className={co.redc}>{i.state}</td>}
        <td><Link href={``}><Button variant="outline-warning">See Detail</Button></Link></td>
      </tr>
      );
    });
  ...
  return (
    <SSRProvider>
            ...
            <div className={`col-12`}>
              ...
              <div className={`col-12 ${styles.searchBox} ${co.searchBox}`}>
                <div className={`row `}>
                  ...
                  <div className={`col-6 col-xl-3 col-md-6 g-3 my-3`}>
                    <div className={styles.box2}>
                      <ul className={styles.boxList2} onClick={dropdown2}>
                        ...
                        <li className={styles.listItem21}>Success</li>
                        <li className={styles.listItem21}>Fail</li>
                      </ul>
                    </div>
                  </div>
      ...
      <ReactPaginate
          ...
          />
          <h6 className={`${co.itemnum}`}>See {itemPerPage} from {txt.length} record</h6>
                </div>

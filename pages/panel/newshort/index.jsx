...
const Courses = (props) => {
  ...
  const txt= <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
  ...
  const vid= <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38">
  ...
  const snd= <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44">
          ...
          {({ errors, touched, values }) => (
            <Form className={co.form}>
              ...
              >
               ...
               <div className={`form-check col-4 p-4 ${co.radioHolder}`}>
                <div>
                            <Field
                          ...
                          <div className={`form-check col-4 p-4 ${co.radioHolder}`}><div>
                            <Field
                              className={`form-check-input ${co.radio}`}
                              type="radio"
                              name="radio"
              ...
              >
                <div className={`row ${co.preview} `}>
                  <div className={`row `}>
                    <h6 className={`${co.landingCourseTitle}`}>course content</h6>
                    ...
                    <div className={co.modal}>
                      ...
                      <h6 className={`${co.landingCourseTitle}`}>Poster for your content</h6>
                      <div className={`row ${co.upholder}`}>
                        <div className={`${co.uploadbox}`}>

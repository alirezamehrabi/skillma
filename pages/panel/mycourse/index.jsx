...
const Courses = () => {
  ...
  const [txt, setTxt] = useState([
    {num:"1",task:"Design",course:"Course Name 1",Date:"sep 10 , 2022",Progress:"40"},
    {num:"2",task:"Develop",course:"Course Name 2",Date:"sep 10 , 2022",Progress:"10"},
    {num:"3",task:"Design",course:"Course Name 3",Date:"sep 10 , 2022",Progress:"50"},
    {num:"4",task:"Develop",course:"Course Name 4",Date:"sep 10 , 2022",Progress:"80"},
    {num:"5",task:"Design",course:"Course Name 5",Date:"sep 10 , 2022",Progress:"35"},
    {num:"6",task:"Develop",course:"Course Name 6",Date:"sep 10 , 2022",Progress:"85"},
  ])
  ...
  const displayItems = txt
    ...
    .map((i) => {
      return (
        ...
        <td>{i.course}</td>
        <td>{i.task}</td>
        <td><ProgressBar now={i.Progress} label={`${i.Progress}%`} /></td>
        <td>{i.Date}</td>
        <td><Link href={``}><Button variant="outline-warning">Start Learning</Button></Link></td>
      </tr>
      );
    });

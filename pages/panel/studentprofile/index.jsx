...
import StuProfile from "../../../src/components/panel/StuProfile/StuProfile.jsx";
import StuCertification from "../../../src/components/panel/StuCertification/StuCertification.jsx";
import StuRecommendation from "../../../src/components/panel/StuRecommendation/StuRecommendation.jsx";
import StuAsk from "../../../src/components/panel/StuAsk/StuAsk.jsx";
      ...
      <div className={`${dash.container}`}>
        <div className={`row d-flex justify-content-between`}>
          ...
          <div className={`col-lg-10 ${dash.maincontainer}`}>
            ...
            className={`mb-5 ${search.tabs} ${search.tabs3} changeTab1`}
          >
            ...
            <Tab eventKey="Question" title="Ask Question">
              <div className={`col-12`}>
              <StuAsk/>
              </div>
            </Tab>
            <Tab eventKey="Public" title="Profile Public">
              <div className={`col-12`}>
              </div>
            </Tab>
          </Tabs>

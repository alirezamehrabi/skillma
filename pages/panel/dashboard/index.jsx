                            ...
                            <div className={`row justify-content-start`}>
                                <div className={`col-md-8 ${dash.leftitemholder}`}>
                                    <div className={`col-12 ${dash.static}`}>
                                        <div className={`row`}>
                                            <div className={`col-lg-3 col-sm-6 `}>{connection}<h6 className={``}>Connection</h6><h5 className={``}>1.523</h5></div>
                                            <div className={`col-lg-3 col-sm-6 `}>{short}<h6 className={``}>Short Content</h6><h5 className={``}>523</h5></div>
                                            <div className={`col-lg-3 col-sm-6 `}>{courses}<h6 className={``}>Course</h6><h5 className={``}>12</h5></div>
                                            <div className={`col-lg-3 col-sm-6 `}>{income}<h6 className={``}>Income</h6><h5 className={``}>12</h5></div>
                                        </div>
                                    </div>

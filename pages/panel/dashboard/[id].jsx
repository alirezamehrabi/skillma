...
import Chart from "../../../src/components/panel/Chart/Chart.tsx"
                        ...
                        <div className={`col-12`}>
                            <div className={`row justify-content-start`}>
                                <div className={`col-md-8 ${dash.leftitemholder}`}>
                                    <div className={`col-12 ${dash.static}`}>
                                        <div className={`row`}>
                                            <div className={`col-lg-3 col-sm-6 `}>{connection}<h6 className={``}>Connection</h6><h5 className={``}>{dt.connectionCount}</h5></div>
                                            <div className={`col-lg-3 col-sm-6 `}>{short}<h6 className={``}>Short Content</h6><h5 className={``}>{dt.shortContent}</h5></div>
                                            <div className={`col-lg-3 col-sm-6 `}>{courses}<h6 className={``}>Course</h6><h5 className={``}>{dt.courseCount}</h5></div>
                                            <div className={`col-lg-3 col-sm-6 `}>{income}<h6 className={``}>Income</h6><h5 className={``}>{dt.inCome}</h5></div>
                                        </div>
                                    </div>
                                    <div className={`col-12 ${dash.process}`}>
                                        <h6 className={``}>Finish your Course for Publish</h6>
                                        <div className={`row`}>
                                            <div className={`col-md-6 mb-4 g-4`}>
                                                <div className={`col-12 ${dash.leftprocess}`}>
                                                    <h5 className={``}>UI course</h5>
                                                    <h6 className={``}>Lorem Ipsum is simply dummy text of the.</h6>
                                                    <ProgressBar variant="warning" now={20} className={`mb-5`} />
                                                    <h6 className={`${dash.draft}`}>Draft</h6><span className={`${dash.edit}`}>{edit}</span>

                                                </div>
                                            </div>
                                            <div className={`col-md-6 g-4`}>
                                                <div className={`col-12 ${dash.rightprocess}`}>
                                                    <h5 className={``}>UX course</h5>
                                                    <h6 className={``}>Lorem Ipsum is simply dummy text of the.</h6>
                                                    <ProgressBar variant="primary" now={80} className={`mb-5`} />
                                                    <h6 className={`${dash.draft}`}>Draft</h6><span className={`${dash.edit2}`}>{edit}</span>

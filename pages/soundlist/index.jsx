...
const Search = () => {
  ...
  const fetchData0 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredSounds?page=${p}&pageSize=6&Types=0`
        );
  ...
  const fetchData1 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredSounds?page=${p}&pageSize=6&Types=1`
        );
        const json = await result.json();
        // console.log(json.data.pageData)
      return json.data
  ...
  const fetchData2 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredSounds?page=${p}&pageSize=6&Types=2`
        );
        const json = await result.json();
        // console.log(json.data.pageData)
      return json.data
  ...
  const fetchData3 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredSounds?page=${p}&pageSize=6&Types=3`
        );
        const json = await result.json();
        // console.log(json.data.pageData)
      return json.data
        ...
        <main>
          ...
          <div className={`col-12`}>
              <div className={`col-sm-8 ${search.titleSound}`}>Sounds</div>
                <SoundList fetchData0={fetchData0} fetchData1={fetchData1} fetchData2={fetchData2} fetchData3={fetchData3}/>
              </div>
        </section>

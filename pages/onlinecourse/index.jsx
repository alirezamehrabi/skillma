...
export async function getStaticProps() {
    const res = await fetch(
      `${process.env.webURL}/OnlineCourse/GetFilteredOnlineCourses?page=1&pageSize=2&Types=1`
    );
...
const Maincourse = (props) => {
    const data = props.data.data.pageData
// console.log(props.data.data.totalCount)
    const [show, setShow] = useState(false);
      ...
      const [mydata, setmyata] = useState(props.data.data.pageData);
      ...
      const pageCount = props.data.data.totalPage;
      const datadisplay = props.data.data.pageData.map((i) => {
        return(
            <div className="col-4">
            <div className={`col-11 ${styles.shortSlidePic} ${styles.shortSlidePic2}`}>
          <Link href="#" >
            <>
              <figure className={``} >
                <Image

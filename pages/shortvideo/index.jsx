...
import ShortVideo from "../../src/components/ShortVideo/ShortVideo"
...
const VC = () => {
  ...
  const fetchData0 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredShortVideo?page=${p}&pageSize=6&Types=0`
        );
  ...
  const fetchData1 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredShortVideo?page=${p}&pageSize=6&Types=1`
        );
        const json = await result.json();
        // console.log(json.data.pageData)
      return json.data
  ...
  const fetchData2 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredShortVideo?page=${p}&pageSize=6&Types=2`
        );
        const json = await result.json();
        // console.log(json.data.pageData)
      return json.data
  ...
  const fetchData3 = async (p)=>{
    try {
      const result = await fetch(
        `${process.env.webURL}/ShortContent/GetFilteredShortVideo?page=${p}&pageSize=6&Types=3`
        );
        const json = await result.json();
        // console.log(json.data.pageData)
      return json.data
      ...
      <div className={styles.container}>
        ...
        <main>
          ...
          <div className={`col-12`}>
              <div className={`col-sm-8 fw-bolder my-4`}>Short Videos</div>
                <ShortVideo fetchData0={fetchData0} fetchData1={fetchData1} fetchData2={fetchData2} fetchData3={fetchData3}/>
              </div>
        </section>

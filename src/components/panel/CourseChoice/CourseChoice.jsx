    ...
    <SSRProvider>
      <div className={`row`}>
              <div className={`col-12 ${co.courseTitle}`}>
                <h6 className={``}>Create new Course</h6>
              </div>
              <div className={`col-12 ${co.courseSec}`}>
                <h6 className={`${co.courseSecTitle}`}>
                  First, let us find out what type of course you are making.
                </h6>

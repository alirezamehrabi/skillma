                ...
                <div className={`col-12 mx-auto`}>
                  <div className={`row ${styles.courseBotton}`}>
                    ...
                    <Link href="#">
                      <button
                        type="button"
                        className={`btn btn-warning ${styles.logBut} ${styles.courseBut}`} onClick={() => {
                          handleShow();
                          setModalData(i);
                        }}
                      >
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
              <div className={` ${styles.introHolder}`}>
                <video src={modalData.videoPath} autoPlay controls />
              </div>
            </Modal.Body>
            <Modal.Footer>
              <div className={`row ${styles.conHolder}`}>
                <div className={`col-6`}>
                  <figure className={`${styles.teacherBadgeModal}`}>
                    <Image
                      src={modalData.teacherPic}
                      alt="logo"
                      width="40"
                      height="40"
                    />
                    <h5 className={``}>{modalData.teacherName}</h5>
                    <h6 className={``}>
                      <Moment fromNow>{modalData.creationAgo}</Moment>
                    </h6>
                  </figure>
                </div>

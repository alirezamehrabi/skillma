        ...
        <div className={`col-11 ${styles.shortSlidePic}`}>
          <Link href="#" >
            <>
              <figure className={``} >
                <Image
                  src={require(`../../../src/assets/home/shortvideo.png`)}
                  alt="logo"
                  width=""
                  height=""
                />
              ...
              <figure className={`${styles.shortContent}`} >
                <Image  onClick={handleShow}
                  ...
                  height=""
                />
                <h6 className={``}  onClick={handleShow}>Get Started with Adobe XD</h6>
                <Rating
            ...
            <>
              ...
              <figure className={`${styles.shortContent}`}>
                <Image
                  ...
                  height=""
                />
                <h6 className={``}>Get Started with Adobe XD</h6>
                <Rating
                  onClick={handleRating}
                  allowFraction={true}
                  // onPointerEnter={onPointerEnter}
